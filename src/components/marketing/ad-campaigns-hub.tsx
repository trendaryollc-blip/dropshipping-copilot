...
import { Megaphone, TrendingUp, MousePointer, ShoppingBag, Plus, Play, Pause, Trash2, DollarSign, BarChart3, ArrowRight } from "lucide-react"
...
export function AdCampaignsHub() {
    ...
    <div className="space-y-6">
        ...
        <div className="relative z-10 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex items-center gap-3">
            <AIActionButton
              ...
              label="AI Ad Copy"
              onSuccess={() => toast.success("AI ad copy generated")}
            />
      ...
      <section className="space-y-4 animate-in delay-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-muted-foreground">— boost your marketing</span>
        </div>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
