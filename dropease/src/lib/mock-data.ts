...
export const products: Product[] = [
  { id: "1", name: "Wireless Earbuds Pro", image: "https://picsum.photos/seed/earbuds/400/300", niche: "Electronics", priceRange: { min: 15, max: 45 }, competition: "low", trendScore: 87, supplierName: "TechSupply Co", status: "active", importedAt: "2024-01-10", views: 1240 },
  ...
  { id: "3", name: "Portable LED Desk Lamp", image: "https://picsum.photos/seed/lamp/400/300", niche: "Home & Garden", priceRange: { min: 12, max: 35 }, competition: "low", trendScore: 91, supplierName: "HomeGoods Direct", status: "draft", views: 630 },
  { id: "4", name: "Bamboo Cutting Board Set", image: "https://picsum.photos/seed/bamboo/400/300", niche: "Home & Garden", priceRange: { min: 8, max: 25 }, competition: "medium", trendScore: 65, supplierName: "EcoSupply", status: "active", importedAt: "2024-01-08", views: 450 },
  { id: "5", name: "Facial Roller Massager", image: "https://picsum.photos/seed/roller/400/300", niche: "Beauty", priceRange: { min: 6, max: 20 }, competition: "high", trendScore: 78, supplierName: "BeautyPro", status: "active", importedAt: "2024-01-15", views: 2100 },
  { id: "6", name: "Resistance Band Set", image: "https://picsum.photos/seed/bands/400/300", niche: "Sports", priceRange: { min: 10, max: 30 }, competition: "low", trendScore: 83, supplierName: "FitGear Supply", status: "draft", views: 380 },
  { id: "7", name: "Phone Grip Stand", image: "https://picsum.photos/seed/phonegrip/400/300", niche: "Electronics", priceRange: { min: 3, max: 12 }, competition: "high", trendScore: 55, supplierName: "TechSupply Co", status: "archived", views: 980 },
  { id: "8", name: "Reusable Water Bottle", image: "https://picsum.photos/seed/bottle/400/300", niche: "Sports", priceRange: { min: 8, max: 22 }, competition: "medium", trendScore: 70, supplierName: "EcoSupply", status: "active", importedAt: "2024-01-09", views: 760 },
  ...
  { id: "10", name: "Magnetic Phone Wallet", image: "https://picsum.photos/seed/wallet/400/300", niche: "Fashion", priceRange: { min: 4, max: 15 }, competition: "medium", trendScore: 68, supplierName: "FashionHub", status: "draft", views: 340 },
  { id: "11", name: "Essential Oil Diffuser", image: "https://picsum.photos/seed/diffuser/400/300", niche: "Beauty", priceRange: { min: 14, max: 38 }, competition: "medium", trendScore: 75, supplierName: "BeautyPro", status: "active", importedAt: "2024-01-13", views: 890 },
  { id: "12", name: "Foldable Travel Bag", image: "https://picsum.photos/seed/bag/400/300", niche: "Fashion", priceRange: { min: 10, max: 28 }, competition: "low", trendScore: 88, supplierName: "FashionHub", status: "active", importedAt: "2024-01-14", views: 1450 },
]
